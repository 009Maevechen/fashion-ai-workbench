module.exports={
  ...
  rebuildConfig:{},
  makers:[{name:"@electron-forge/maker-squirrel",config:{name:"ai_fashion_workbench",authors:"AI Fashion Workbench",description:"AI服装图片生产工作台",setupExe:"AI服装工作台 Setup.exe",setupIcon:"build/icons/icon.ico",noMsi:true}},{name:"@electron-forge/maker-dmg",config:{name:"AI服装工作台",format:"ULFO"},platforms:["darwin"]}],
