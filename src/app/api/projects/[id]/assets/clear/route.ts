...
export async function DELETE(_:Request,{params}:{params:Promise<{id:string}>}){
  try{
    ...
    await updateProject(id,{assets:cleanup.assets,assetEvidence:{},productVisualAnalysis:undefined,targetColors:cleanup.targetColors,poseReferenceInputs:[],selectedPoseTemplateGroupId:undefined,poseTemplateSnapshot:undefined,garmentDetailLock:undefined});
