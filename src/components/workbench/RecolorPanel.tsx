...
export default function RecolorPanel({p,jobs,historyJobs,health,modelRouting,busy,run,refreshProject,persistAsset,deleteAsset,clearSourceAssets,clearWorkflowResults,saveProject,post}:PanelProps&{historyJobs:Job[]}){
