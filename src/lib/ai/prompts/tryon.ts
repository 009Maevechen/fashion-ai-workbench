...
- 模特参考图：这是生成结果中“画面主体”的唯一来源和唯一真值——包括且不限于：人物身份与脸部、发型、姿势、动作、肢体姿态、身体比例、站位、景别（全身/半身/特写及画面裁切范围）、镜头视角、构图、场景、背景、光线与阴影。模特参考图里的服装只是需要被移除的遮挡物，不是设计参考；其款式、版型、覆盖范围、长短、松紧、颜色、图案、面料、纹理、垂感和任何细节全部忽略，一律不参考、不保留、不混入。
