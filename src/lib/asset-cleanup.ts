...
export const CLEARABLE_SOURCE_KEYS=["garmentImage","garmentEnhancedImage","garmentCropImage","productFrontImage","productBackImage","productDetailImage","printCloseupImage","buttonCloseupImage","pocketCloseupImage","necklineCloseupImage","sleeveCloseupImage","hemCloseupImage","stitchingCloseupImage","modelReferenceImage","fabricTextureImage","otherMaterialImages","modelImage","standalonePoseInputImage","poseReferenceImages","colorReferenceImage","standaloneRecolorPoseImages"] as const satisfies readonly (keyof ProjectAssets)[];
