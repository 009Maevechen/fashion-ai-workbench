...
export type VariantColorRegion={part:string;colorName:string;hex?:string;confidence:number};
export type TargetColor={id:string;name:string;outputName?:string;baseHex?:string;hex?:string;trimColorName?:string;trimHex?:string;colorAdjustment?:ColorAdjustment;designDetails?:string[];materialFeatures?:string;colorRegions?:VariantColorRegion[];isUniformColor?:boolean;uniformColorConfidence?:number;occlusion?:"none"|"partial"|"heavy";occlusionPolicy?:"visible_only"|"extend_uniform";occlusionReason?:string;designConfidence?:number;designNeedsReview?:boolean;manualReviewConfirmed?:boolean;cropImage?:string;cropRegion?:{x:number;y:number;width:number;height:number};status:"draft"|"ready"|"generating"|"partial_success"|"success"|"failed"|"confirmed"|"stale";generationStartedAt?:string;poseResults?:string[];sourceCount?:number;protectedAreas?:string[]};
