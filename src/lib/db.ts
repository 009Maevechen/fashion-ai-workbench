...
export type TryonSubjectFidelityCheck={status:"passed"|"needs_review"|"failed";basedOnModel:boolean;poseMatch:boolean;shotMatch:boolean;closerToProduct:boolean;score:number;summary:string;issues:string[];checkedAt:string;model?:string};
